...
export default function FontExample() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Font Example</CardTitle>
        <CardDescription>
          This is an example of using different font styles in a card component.
        </CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
          ...
          <h4 className="text-base">Heading 4</h4>
          <h5 className="text-sm">Heading 5</h5>
          <h6 className="text-xs">Heading 6</h6>
        </div>
        <hr className="my-6" />
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <div className="space-y-2">
                <p className="text-base">
                  This is regular body text in Inter. Lorem ipsum dolor sit
